...
export const AcionamentoSinistro = () => {
    return(
        <>
        <Header RemoverInput/>
        <BodySolucoes titulo = {"Acionamento de Sinistro"} img = {imgAcionamentoSinistro} texto = {paragrafoAcionamentoS} descricao= "Imagem de uma pessoa ligando para algúem/algum lugar" />
        <Footer />
        </>
    )
}